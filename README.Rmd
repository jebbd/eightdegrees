...
This is primarily an opportunity to create colour palettes and learn some R package development. Both scale_colour_* and scale_fill_* functions are included.
